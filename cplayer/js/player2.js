		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t += '\n<video\n    class="yzmplayer-video ', o && (t += "yzmplayer-video-current"), t +=
					...
					(l || n) && (t += 'crossorigin="anonymous1"'), t += "\n    ", c && (t += 'preload="', t += r(c), t += '"'), t +=
					"\n    ", u && (t += 'src="', t += r(u), t += '"'), t += "\n    >\n    ", n && (t +=
				...
				o = function() {
					...
					return a(e, [{
						...
						value: function() {
							...
							this.template.infoVersion.innerHTML = "10.6.6", this.template.infoType.innerHTML = this.player.type, this.template
